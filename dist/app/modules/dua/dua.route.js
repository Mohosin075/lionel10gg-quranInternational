...
router.get('/categories', dua_controller_1.DuaController.getCategories);
...
router.patch('/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), dua_controller_1.DuaController.updateDua);
router.put('/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), dua_controller_1.DuaController.updateDua);
router.delete('/:id', (0, auth_1.default)(user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), dua_controller_1.DuaController.deleteDua);
