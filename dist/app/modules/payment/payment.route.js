...
router.get('/donation-presets', payment_controller_1.PaymentController.getDonationPresets);
router.get('/verify-checkout/:sessionId', (0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN), payment_controller_1.PaymentController.verifyCheckoutSession);
router.get('/:id', (0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.SUPER_ADMIN, user_1.USER_ROLES.ADMIN), payment_controller_1.PaymentController.getSinglePayment);
...
router.post('/ephemeral-key', (0, auth_1.default)(user_1.USER_ROLES.USER, user_1.USER_ROLES.ADMIN, user_1.USER_ROLES.SUPER_ADMIN), payment_controller_1.PaymentController.createEphemeralKey);
// ============================================
// EXISTING ROUTES
// ============================================
