  ...
  return (socket, next) => {
    try {
      ...
      try {
        ...
        // Verify token
        const verifiedUser = jwtHelper_1.jwtHelper.verifyToken(
          jwtToken,
        ...
        console.log(
          colors_1.default.green(
            `Socket authenticated for user: ${verifiedUser.authId}`,
          ),
        )
        next()
      } catch (error) {
  ...
  if (typeof token === 'string') {
    if (token.includes('{')) {
      try {
        ...
        return (
          ((_a =
            parsedToken === null || parsedToken === void 0
              ? void 0
              : parsedToken.token) === null || _a === void 0
            ? void 0
            : _a.split(' ')[1]) ||
          (parsedToken === null || parsedToken === void 0
            ? void 0
