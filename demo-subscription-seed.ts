...
const demoTiers = [
  {
    ...
    stripeProductId: 'prod_premium_tier_499',
    priority: 1,
  },
  {
    ...
    isActive: true,
    stripePriceId: 'price_tier_999',
    stripeProductId: 'prod_premium_tier_999',
    priority: 2,
  },
  {
    ...
    stripeProductId: 'prod_premium_tier_1999',
    priority: 3,
  },
  {
    name: 'Premium Support (€24.99)',
    description: 'Unlock 14 features and support Quran App',
    price: 24.99,
    currency: 'eur',
    interval: 'month' as const,
    ...
    features: ['Unlock all 14 premium features'],
    isActive: true,
    stripePriceId: 'price_tier_2499',
    stripeProductId: 'prod_premium_tier_2499',
    priority: 4,
  },
  {
    name: 'Premium Support (€34.99 Annual)',
    description: 'Unlock 14 features and support Quran App',
    price: 34.99,
    currency: 'eur',
    ...
    features: ['Unlock all 14 premium features'],
    isActive: true,
    stripePriceId: 'price_tier_3499_yr',
    stripeProductId: 'prod_premium_tier_3499_yr',
    priority: 5,
  },
  {
    name: 'Premium Support (€44.99 Annual)',
    description: 'Unlock 14 features and support Quran App',
    price: 44.99,
    currency: 'eur',
    interval: 'year' as const,
    ...
    features: ['Unlock all 14 premium features'],
    isActive: true,
    stripePriceId: 'price_tier_4499_yr',
    stripeProductId: 'prod_premium_tier_4499_yr',
    priority: 6,
  },
  {
    name: 'Premium Support (€55.99 Annual)',
    description: 'Unlock 14 features and support Quran App',
    price: 55.99,
    currency: 'eur',
    interval: 'year' as const,
    ...
    features: ['Unlock all 14 premium features'],
    isActive: true,
    stripePriceId: 'price_tier_5599_yr',
    stripeProductId: 'prod_premium_tier_5599_yr',
    priority: 7,
  },
  {
    name: 'One-Time Donation (€100.00 Lifetime)',
    description: 'Unlock all premium features lifetime',
    price: 100.00,
    currency: 'eur',
    interval: 'lifetime' as const,
    intervalCount: 1,
    features: ['Unlock all 14 premium features lifetime'],
    isActive: true,
    stripePriceId: 'price_tier_10000_lifetime',
    stripeProductId: 'prod_premium_tier_10000_lifetime',
    priority: 8,
  },
]
