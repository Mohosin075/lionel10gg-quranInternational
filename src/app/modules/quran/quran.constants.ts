import { ISurahMetadata } from './quran.interface';
...
export const LANGUAGE_TO_AUDIO_KEY: Record<string, typeof AUDIO_TRANSLATIONS[number]> = {
  'en': 'english_rwwad',
  'fr': 'french_rashid',
  'pt': 'portuguese_nasr',
  'nl': 'dutch_center',
...
export const DEFAULT_AUDIO_KEY = 'english_rwwad';

export const SURAH_LIST: ISurahMetadata[] = [
  ...
  { number: 33, name: "سُورَةُ الأَحۡزَابِ", englishName: "Al-Ahzaab", englishNameTranslation: "The Combined Forces", numberOfAyahs: 73, revelationType: "Medinan" },
  ...
  { number: 36, name: "سُورَةُ يس", englishName: "Ya-Seen", englishNameTranslation: "Ya-Seen", numberOfAyahs: 83, revelationType: "Meccan" },
  ...
  { number: 43, name: "سُورَةُ الزُّخۡرُفِ", englishName: "Az-Zukhruf", englishNameTranslation: "The Ornaments of Gold", numberOfAyahs: 89, revelationType: "Meccan" },
  ...
  { number: 45, name: "سُورَةُ الجَاثِيَةِ", englishName: "Al-Jaathiya", englishNameTranslation: "The Crouching", numberOfAyahs: 37, revelationType: "Meccan" },
  { number: 46, name: "سُورَةُ الأَحۡقَافِ", englishName: "Al-Ahqaaf", englishNameTranslation: "The Wind-Curved Sandhills", numberOfAyahs: 35, revelationType: "Meccan" },
  ...
  { number: 49, name: "سُورَةُ الحُجُرَاتِ", englishName: "Al-Hujuraat", englishNameTranslation: "The Rooms", numberOfAyahs: 18, revelationType: "Medinan" },
  ...
  { number: 52, name: "سُورَةُ الطُّورِ", englishName: "At-Toor", englishNameTranslation: "The Mount", numberOfAyahs: 49, revelationType: "Meccan" },
  ...
  { number: 55, name: "سُورَةُ الرَّحۡمَٰنِ", englishName: "Ar-Rahmaan", englishNameTranslation: "The Beneficent", numberOfAyahs: 78, revelationType: "Medinan" },
  ...
  { number: 62, name: "سُورَةُ جُمُعَة", englishName: "Al-Jumu'a", englishNameTranslation: "The Congregation", numberOfAyahs: 11, revelationType: "Medinan" },
  ...
  { number: 64, name: "سُورَةُ التَّغَابُنِ", englishName: "At-Taghaabun", englishNameTranslation: "The Mutual Disillusion", numberOfAyahs: 18, revelationType: "Medinan" },
  ...
  { number: 66, name: "سُورَةُ التَّحۡرِيمِ", englishName: "At-Tahreem", englishNameTranslation: "The Prohibition", numberOfAyahs: 12, revelationType: "Medinan" },
  ...
  { number: 81, name: "سُورَةُ التَّكۡوِيرِ", englishName: "At-Takweer", englishNameTranslation: "The Overthrowing", numberOfAyahs: 29, revelationType: "Meccan" },
  ...
  { number: 83, name: "سُورَةُ المُطَفِّفِينَ", englishName: "Al-Mutaffifeen", englishNameTranslation: "The Defrauding", numberOfAyahs: 36, revelationType: "Meccan" },
  { number: 84, name: "سُورَةُ الإِنشِقَاقِ", englishName: "Al-Inshiqaaq", englishNameTranslation: "The Sundering", numberOfAyahs: 25, revelationType: "Meccan" },
  ...
  { number: 86, name: "سُورَةُ الطَّارِقِ", englishName: "At-Taariq", englishNameTranslation: "The Nightcomer", numberOfAyahs: 17, revelationType: "Meccan" },
  ...
  { number: 92, name: "سُورَةُ اللَّيۡلِ", englishName: "Al-Layl", englishNameTranslation: "The Night", numberOfAyahs: 21, revelationType: "Meccan" },
  ...
  { number: 94, name: "سُورَةُ الشَّرۡحِ", englishName: "Ash-Sharh", englishNameTranslation: "The Relief", numberOfAyahs: 8, revelationType: "Meccan" },
  ...
  { number: 98, name: "سُورَةُ البَيِّنَةِ", englishName: "Al-Bayyina", englishNameTranslation: "The Clear Proof", numberOfAyahs: 8, revelationType: "Medinan" },
  ...
  { number: 100, name: "سُورَةُ العَادِيَاتِ", englishName: "Al-Aadiyat", englishNameTranslation: "The Courser", numberOfAyahs: 11, revelationType: "Meccan" },
  { number: 101, name: "سُورَةُ القَارِعَةِ", englishName: "Al-Qaaria", englishNameTranslation: "The Calamity", numberOfAyahs: 11, revelationType: "Meccan" },
  ...
  { number: 107, name: "سُورَةُ المَاعُونَ", englishName: "Al-Maa'oon", englishNameTranslation: "The Small Kindnesses", numberOfAyahs: 7, revelationType: "Meccan" },
  ...
  { number: 110, name: "سُورَةُ النَّصۡرِ", englishName: "An-Nasr", englishNameTranslation: "The Divine Support", numberOfAyahs: 3, revelationType: "Medinan" },
  ...
  { number: 112, name: "سُورَةُ الإِخۡلَاصِ", englishName: "Al-Ikhlaas", englishNameTranslation: "The Sincerity", numberOfAyahs: 4, revelationType: "Meccan" },
